...
\begin{figure}[h!]
  ...
  \caption{Convergencia de ambos algoritmos}
  \label{fig:convergencia}
\end{figure}

Ambos algoritmos convergen a los mismos valores de los estados, aunque según
la figura \ref{fig:convergencia}, el algoritmo de actualización in place
converge mucho más rápido que el de actualización simultánea.
...
Mientras que para $q_\pi(11,\text{down})$ se le agrega el nodo terminal,
el cual es cero, en el caso de $q_\pi(7,\text{down})$ se le agrega el valor
del estado 11, que proviene de la resolución del modelo en el libro
de Sutton y Barto.
...
Tiene sentido que el valor de $\nu_\pi(15)$ sea -20, igual al de
$\nu_\pi(13)$, ya que desde ambos estados se puede mover a
casilleros con los mismos valores (-22, -20, -14).

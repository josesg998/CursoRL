...
\begin{align}
\tag{1} &= R_{C1} + \gamma R_{C2} + \gamma^2 R_{C3} + \gamma^3 R_{PASS}  + \gamma^4 R_{SLEEP} \\
\tag{2} &= -2     + 0.5 * -2      + 0.5^2 * -2      + 0.5^3 * 10         + 0.5^4 * 0 \\
\tag{3} &= -2 + -1 + -0.5 + 1.25 + 0 = -2.25
\end{align}

\subsubsection{Inciso 2}
\begin{align}
\tag{1} &= R_{C1} + \gamma R_{FB} + \gamma^2 R_{FB} + \gamma^3 R_{C1} + \gamma^4 R_{C2} + \gamma^5 R_{SLEEP} \\
\tag{2} &= -2     + 0.5 * -1      + 0.5^2 * -1      + 0.5^3 * -2      + 0.5^4 * -2      + 0.5^5 * 0 \\
\tag{3} &= -2 + -0.5 + -0.25 + -0.25 + -0.125 + 0 = -3.125
\end{align}

\subsubsection{Inciso 3}
\begin{align}
\tag{1} &= R_{C1} + \gamma R_{C2} + \gamma^2 R_{C3} + \gamma^3 R_{PUB} + \gamma^4 R_{C2} + \gamma^5 R_{C3} + \gamma^6 R_{PASS} + \gamma^7 R_{SLEEP} \\
\tag{2} &= -2     + 0.5 * -2      + 0.5^2 * -2      + 0.5^3 * 1      + 0.5^4 * -2      + 0.5^5 * -2      + 0.5^6 * 10         + 0.5^7 * 0 \\
\tag{3} &= -2     + -1            + -0.5            + 0.125            + -0.125           + -0.0625          + 0.15625            + 0  = 3.40625
\end{align}

\subsubsection{Inciso 4}
\begin{align}
\tag{1} &= R_{C1} + \gamma R_{FB} + \gamma^2 R_{FB} + \gamma^3 R_{C1} + \dots + \gamma^{16} R_{SLEEP} \\
\tag{2} &= -2     + 0.5 * -1      + 0.5^2 * -1      + 0.5^3 * -2      + \dots + 0.5^{16} * 0 \\
\tag{3} &= -3.196044921875
\end{align}
...
gamma = 0.9
	Iterando [-3.68  3.28  6.47 13.12  3.85 -7.    3.46]
	Gauss	   [-3.68  3.28  6.47 13.12  3.85 -7.    3.46]
	Inversa	 [-3.68  3.28  6.47 13.12  3.85 -7.    3.46]
\end{lstlisting}

...
\section{Ejercicio 1} % TODO no entendí
...
def value_iteration(P, R, gamma, theta=1e-6, max_iterations=1000):
    n_states = P.shape[0]
    V = np.zeros(n_states)
...
def value_iteration_in_place(P, R, gamma, theta=1e-6, max_iterations=1000):
    n_states = P.shape[0]
    V = np.zeros(n_states)
...
V1 = value_iteration(P, R, gamma)
V2 = value_iteration_in_place(P, R, gamma)

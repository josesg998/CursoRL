        ...
        for W_EMP_POS in RANGOS:
            for W_EMP_NEG in RANGOS:
                for Q in Qs:
                    ...
                    suscept_histories = []
                    for seed in seeds:
                        print(f"Corriendo simulación con W_NOR_POS={W_NOR_POS:.2f}, W_NOR_NEG={W_NOR_NEG:.2f}, W_EMP_POS={W_EMP_POS:.2f}, W_EMP_NEG={W_EMP_NEG:.2f} Q{Q} semilla {seed}")
...
file_name = "simulacion_10_seeds_susceptibility_Q.json"
